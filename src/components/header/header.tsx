...
type PropsTypes = { logIn: string, setMeLogOutThunk: () => void, themes: { headerDynamic: string, logotypeH1: string, loginH4: string, loginHref: string } }

// let Header: React.FC<PropsTypes> =(props:PropsTypes) => {  

let Header: React.FC<PropsTypes> = ({ logIn, setMeLogOutThunk, themes }) => {
  // console.log(props)
