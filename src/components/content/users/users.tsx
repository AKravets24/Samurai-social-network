...
export let Users:React.FC<UsersProps_Type> = ({themes,usersInfo,usersFuncs}) => {
    ...
    let setPageListener  = (pageSize:number,page:number) => {usersFuncs.setCurrentPageThunk(pageSize,page);
    ...
    let searchModeCloseListener = () => {searchMode&&usersFuncs.setCurrentPageThunk(0,1);usersFuncs.setErrorToNull();usersFuncs.updateSearchField('');
    /*searchMode&&
    setSearchMode(false)*/
    };
    // useEffect(()=>{
    ...
    return <>
        ...
        {/* <FeedBacker sendingMSGStatArr={usersInfo.sendingMSGStat} feedBackWindowCloser={usersFuncs.feedBackWindowCloser} /> */}
