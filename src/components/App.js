...
// import {geSmartInitialized, getBackGroundReducer, getAppACs, getBackGroundSetterACs, 
...
//     useEffect(()=>{document.body.style.backgroundImage=`url(${state.backgroundReducer.backgroundPic})`
...
//                         <div className = {stl.content1}> <ContentComposer x ={1}/> </div>
//                     </div>
//             }}
//         </StoreContext.Consumer>
//     </>
