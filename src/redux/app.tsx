...
export const usersApi = {
  ...
  getTalkWithUser2(userId: number, msgCount: number = 10 /* 20 */, pageNumber: number = 1) { return instance.get<CertainDialog_Type>(`dialogs/${userId}/messages?count=${msgCount}&page=${pageNumber}`) },
